...
from FuncVelov3 import validate_workflow, train, plots, set_best_params_from_paper, \
    heldout_test, heldout_testv3
from TrainLoadData import prep_data
...
def main():
    ...
    train_arg_parser.add_argument("--save_logs", type=str, default='./VelodromeTrain/logs/',
                                  help='path of folder to write log')
    train_arg_parser.add_argument("--save_models", type=str, default='./VelodromeTrain/models/',
                                  help='folder for saving model')
    train_arg_parser.add_argument("--save_results", type=str, default='./VelodromeTrain/results/',
                                  help='folder for saving model')
    ...
    set_best_params_from_paper(args, out_dir='VelodromeTrain')
